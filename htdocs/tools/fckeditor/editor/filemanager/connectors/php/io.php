...
function GetRootPath()
{
	...
	if ( $position === false || $position <> strlen( $sRealPath ) - strlen( $sSelfPath ) )
		SendError( 1, 'Извените, не могу преобразовать "UserFilesPath" в физический путь. Вы должны установить "UserFilesAbsolutePath" в "editor/filemanager/connectors/php/config.php".' ) ;
