<?php /* cDeep-3.1.1 (2.6.16), generated on 2013-02-06 09:43:24
         template file:sadm/photo/upload.tpl.php */ ?>
<?php require_once(cDeep_CORE_DIR . 'core.load_plugins.php');
cDeep_core_load_plugins(array('plugins' => array(array('function', 'loader', 'file:sadm/photo/upload.tpl.php', 6, false),array('function', 'PHPSESSID', 'file:sadm/photo/upload.tpl.php', 17, false),)), $this); ?><?php echo cDeep_function_loader(array('src' => 'jquery.js,jquery.form.js,jquery.jframe.js','type' => 'js','comment' => 'JQuery ядро, поддержка JFrame и JForm'), $this); echo cDeep_function_loader(array('src' => 'admin/multiupload.css','type' => 'css','base' => '/css/','comment' => 'FileMultiUpload'), $this); echo cDeep_function_loader(array('src' => 'swfupload.js,swfupload.queue.js,fileprogress.js,handlers.js','type' => 'js','base' => '/js/dl/','comment' => 'FileMultiUpload'), $this); echo '
...
", "id":<?php echo $this->_tpl_vars['id'];  echo '},
				...
				file_types : "*.*",
				file_types_description : "Файлы резюме",
