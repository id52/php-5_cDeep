...
<div class="hilight">
 <fieldset class="inlineLabels">
  ...
  <div class="ctrlHolder">
    ...
    <div class="ctrlHolder">
    <label for="">
      Описание задачи по модернизации
    </label>
	<textarea type="text" name="form[whattodo]">{$form.Form.whattodo}</textarea>
  </div>
    <div class="ctrlHolder">
      <label class="label" for="">
        Реквизиты доступа к вашему сайту
      </label>
    <textarea type="text" name="form[logpass]"  rows=4>{$form.Form.logpass}</textarea>
      <p class="formHint">
        ВАЖНО! зачастую, без данных реквизитов, фактически невозможно расчитать стоимость модернизации
      </p>
    </div>
    <div class="ctrlHolder">
    <label for="">
